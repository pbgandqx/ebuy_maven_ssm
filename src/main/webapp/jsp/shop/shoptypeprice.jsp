    ...
    <div class="content">
        <div class="block">
            ...
            <div class="quick">
                ...
                <button class="price"><a href="#">价格</a></button>
                <button class="sales">销量</button>
            </div>
            <div class="block-wrap">
                <c:forEach var="product" items="${requestScope.getProductShopPirceList}">
                    <div class="item">
                        <a href="<%=basePath%>shop/toshopdetial"><img style="width: 250px;height: 180px;" alt="" src="<%=basePath%>${product.picUrl}"></a>
