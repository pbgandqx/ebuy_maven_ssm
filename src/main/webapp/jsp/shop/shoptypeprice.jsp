    ...
    <div class="content">
        <div class="block">
            ...
            <div class="block-wrap">
                <c:forEach var="getProductShopPirceList" items="${requestScope.getProductShopPirceList}">
                    <div class="item">
                        <a href="<%=basePath%>shop/toshopdetial"><img style="width: 250px;height: 180px;" alt="" src="<%=basePath%>${getProductShopPirceList.picUrl}"></a>
                        <label><em>￥${getProductShopPirceList.price}</em><span>￥${getProductShopPirceList.originalPrice}</span>67人付款</label>
                        <h3>${getProductShopPirceList.name}<button class="buy"><a href="<%=basePath%>shop/toshopdetial?id=${getProductShopPirceList.id}">购买</a></button></h3>
                    </div>
                </c:forEach>
