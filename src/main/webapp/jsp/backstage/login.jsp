...
<link href="jsp/backstage/css/style.css" rel="stylesheet" type="text/css" />
<script language="JavaScript" src="jsp/backstage/js/jquery.js"></script>
<script src="jsp/backstage/js/cloud.js" type="text/javascript"></script>
