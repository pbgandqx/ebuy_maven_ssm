    ...
    <form action="<%=basePath%>backstage/product/doProductupdate" method="post">
        ...
        <ul class="forminfo">
                <li><label>*产品分类</label><select name="productTypeId" class="dfinput">
                    <option value="${requestScope.product.productType.name}">请选择</option>
                ...
                <li><label>*产品描述</label><textarea name="description" cols="90" rows="30" class="textinput"
                                                  value="${requestScope.product.description}">${product.description}</textarea><i></i></li>
                <li><label>*产品内容</label><textarea id="content" name="content" cols="90" rows="30" class="textinput"
                                                  value="${requestScope.product.content}">${product.description}</textarea><i></i></li>
