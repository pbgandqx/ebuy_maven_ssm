...
<div class="formbody">
    ...
    <form action="<%=basePath%>backstage/producttype/doSaveProductType" method="post">
        ...
        <ul class="forminfo">
            <li><label>*产品分类名称</label><input name="name" type="text" class="dfinput"
                                             value="${requestScope.productType.name}"/><i></i></li>
            <li><label>*图片</label>
                <input id="url1" name="imageUrl" type="text" class="dfinput"
                       value="${requestScope.productType.imageUrl}" readonly="readonly"/>
            ...
            <li><label>*优先级</label><input name="orderNum" type="text" class="dfinput"
                                          value="${requestScope.productType.orderNum}"/><i></i></li>
            <li><label>外部链接地址</label><input name="linkUrl" type="text" class="dfinput"
                                            value="${requestScope.productType.linkUrl}"/><i></i></li>
            <li><label>产品描述</label><textarea name="intro" cols="90" rows="30" class="textinput"
                                             value="${requestScope.productType.intro}"></textarea><i></i></li>
