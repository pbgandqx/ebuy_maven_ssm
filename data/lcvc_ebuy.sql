...
Source Database       : lcvc_ebuy

Target Server Type    : MYSQL
Target Server Version : 60011
File Encoding         : 65001

Date: 2017-09-09 17:38:36
*/
...
CREATE TABLE `admin` (
  ...
  `screenName` varchar(20) DEFAULT NULL COMMENT '网名',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('-99', 'liangdian', 'e10adc3949ba59abbe56e057f20f883e', '管理员', '2013-08-23 15:33:01');
INSERT INTO `admin` VALUES ('1', 'user', '123456', '阿斯顿发1', '2013-08-23 15:33:01');
INSERT INTO `admin` VALUES ('2', 'liangxiu1', '123456', '测试账户-梁X1', '2013-08-23 15:33:01');
INSERT INTO `admin` VALUES ('15', '666aasdf', 'e10adc3949ba59abbe56e057f20f883e', '密码是777', '2013-10-15 17:28:57');
INSERT INTO `admin` VALUES ('18', '77676', 'e10adc3949ba59abbe56e057f20f883e', '密码是', '2013-10-15 17:30:01');
...
INSERT INTO `admin` VALUES ('54', '1231231', 'e10adc3949ba59abbe56e057f20f883e', '撒旦法', '2013-10-18 09:21:41');
...
INSERT INTO `admin` VALUES ('79', 'test4', '123456', '撒旦法', '2017-08-25 20:45:32');
...
CREATE TABLE `orders` (
  `orderNo` char(50) NOT NULL COMMENT '订单编号（由业务层生成）',
  `customerId` int(11) DEFAULT NULL COMMENT '客户-外键',
  `sendName` varchar(255) DEFAULT NULL COMMENT '收货人姓名',
  `sendAddress` varchar(255) DEFAULT NULL COMMENT '收货人地址',
  `sendZip` varchar(255) DEFAULT NULL COMMENT '收货人邮编',
  `sendTel` varchar(255) DEFAULT NULL COMMENT '收货人电话',
  `payment` int(11) DEFAULT '1' COMMENT '付款方式（1、货到付款；2、网上支付）',
  `meno` text COMMENT '备注',
  `createTime` datetime DEFAULT NULL COMMENT '生成订单时间',
  `dealTime` datetime DEFAULT NULL COMMENT '交易时间（付钱的时间）',
  `tag` int(11) DEFAULT '2' COMMENT '订单处理标记（1、已付款，2、未付款，3、异常）',
  PRIMARY KEY (`orderNo`),
...
CREATE TABLE `order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  `orderNo` char(50) DEFAULT NULL COMMENT '订单编号（外键）',
  `productId` int(11) DEFAULT NULL COMMENT '产品编号（外键）',
  `price` float DEFAULT NULL COMMENT '交易价格（下订单时的产品价格）',
  `originalPrice` float DEFAULT '0' COMMENT '原价',
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_2` FOREIGN KEY (`creatorId`) REFERENCES `admin` (`userId`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `product_ibfk_3` FOREIGN KEY (`finalEditorId`) REFERENCES `admin` (`userId`) ON DELETE SET NULL ON UPDATE SET NULL
...
INSERT INTO `product` VALUES ('75', '6', '螺蛳粉', '100', '大法师的法师的法师的发大发', '大法师的法师的法师的发大发大法师的法师的法师的发大发', '12', '16', '/lcvc_ebuy/upload/image/20170907/20170907203134_218.jpg', '899', '0', '', '2017-09-07 20:31:47', '1', null, null);
